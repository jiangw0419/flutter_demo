...
class Data {
  ...
  Data.fromJson(Map<String, dynamic> json) {
    ...
    if (json['labelList'] != null) {
      ...
      json['labelList'].forEach((v) {
        // labelList.add(new Issue.fromJson(v));
      });
    }
    header = json['header'];
    ...
    played = json['played'];
    if (json['subtitles'] != String) {
      subtitles = [];
      json['subtitles'].forEach((v) {
        // subtitles.add(fromJson(v));
      });
    }
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.adTrack != null) {
      data['adTrack'] = this.adTrack.map((v) => toJson()).toList();
    }
    data['shade'] = this.shade;
    data['label'] = this.label;
    if (this.labelList != null) {
      data['labelList'] = this.labelList.map((v) =>toJson()).toList();
    }
    ...
    if (this.subtitles != null) {
      data['subtitles'] = this.subtitles.map((v) => toJson()).toList();
    }
